...
import { UserOutlined, SafetyCertificateOutlined, BellOutlined } from '@ant-design/icons';
...
const Account = () => {
  ...
  const onSaveProfile = (values: { name: string; email: string; phone?: string }) => {
    if (!userInfo) return;
    dispatch(
      updateUserInfo({
        ...userInfo,
  ...
  const tabItems = [
      ...
      children: (
        <Card className="account-panel-card" bordered={false}>
          ...
          >
            ...
            <Form.Item>
              <Button type="primary" htmlType="submit" disabled={!isAuthenticated || !userInfo}>
                保存资料
              </Button>
            </Form.Item>
          </Form>
      ...
      children: (
        <Card className="account-panel-card" bordered={false}>
          ...
          >
            ...
            <Form.Item>
              <Button type="primary" htmlType="submit" disabled={!isAuthenticated}>
                更新密码
              </Button>
            </Form.Item>
          </Form>
    ...
    },
    {
      ...
      children: (
        <Card className="account-panel-card" bordered={false}>
          <Space direction="vertical" size="large" className="account-notify-list">
  ...
  return (
    <div className="account-page">
      <div className="account-page-title">
        <Title level={1}>我的账户</Title>
        <Text type="secondary">管理个人资料、安全选项与通知偏好。</Text>
      </div>
        ...
        <Row gutter={[24, 16]} align="middle">
          ...
          <Col flex="1">
            ...
            <Space wrap size={[8, 8]}>
              ...
              {userInfo?.role ? <Text type="secondary">· {userInfo.role}</Text> : null}
            </Space>
          </Col>
          <Col xs={24} md="auto">
      ...
      <Tabs defaultActiveKey="profile" items={tabItems} className="account-tabs" />
    </div>
  );
};
